...
1. **EVM bytecode lane** trusts **powdr `stepF`** + `native_decide` (the pinned
   ...
   powdr witness embedded in `ProofForgeFormalEvm`. The Counter IR↔powdr delivery
