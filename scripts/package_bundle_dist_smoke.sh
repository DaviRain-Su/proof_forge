...
[[ -f "$stage/scripts/pf_solana_test.sh" ]] || die "missing scripts/pf_solana_test.sh (bundle resolve)"
[[ -d "$stage/templates/evm-dapp-ui" ]] || die "missing templates/evm-dapp-ui (scaffold-ui)"
