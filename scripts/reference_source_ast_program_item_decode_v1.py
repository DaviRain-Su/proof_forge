...
FIXTURES = {
    ...
    "ProofDecl": (1, 1, "0900000050726f6f664465636c02000400000073616665020000000600000050726f6f66730400000073616665"),
}
...
def self_check():
    ...
    delegated = (
        ...
        ("ProofDecl", tagged("ProofDecl", 2, u32le(4) + b"safe" + u32le(1) + u32le(4) + b"Only"), 1, 1, "source qualified id must contain 2..256 components"),
    )
