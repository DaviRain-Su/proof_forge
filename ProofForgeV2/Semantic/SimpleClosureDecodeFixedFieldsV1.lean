...
/-! ### Tagged header foundation
    ...
    Production mid-offset tagged-header lemmas now live in
    `Wire.CodecRoundtripV1` (`taggedHeaderBytesV1`, `expectTag_encode_midV1`,
    `decodeTag_encode_midV1`, …). This module reuses them via `open WireV1`.
-/
