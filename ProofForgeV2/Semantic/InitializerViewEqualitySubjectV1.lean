...
/-!
  ...
  a two-slot UInt64-zero initializer, a nullary UInt64 view, and a two-state
  equality invariant. Names remain parameters; execution remains solely in
  `ReferenceMachineV1`.
-/

namespace ProofForgeV2.Semantic.InitializerViewEqualitySubjectV1
...
def subjectDataV1
  ...
  events := #[]
  errors := #[]
  callables := callablesV1 viewName invariantName
...
theorem exactAtRoot_invariantsV1 (invariantName : String) :
    ExactMidOffsetInvertAtV1 (encodeArray encodeInvariantDeclV1)
      ...
      #[{ id := 0, name := invariantName, callableId := 2 }] 1 :=
  exactAt_array_one_of_exactAtV1 encodeInvariantDeclV1 decodeInvariantDeclV1
    maxTableElements (by decide)
    ({ id := 0, name := invariantName, callableId := 2 } : InvariantDeclV1) 1
...
structure StructureLegalV1
    (qualifiedName : QualifiedName)
    (state0Name state1Name viewName invariantName : String) : Prop where
...
theorem callablesValueBytesV1 (viewName invariantName : String) :
  ...
  simp [callablesV1, initializerStoreZeroTwoCallableV1,
    initializerStoreZeroTwoBlockV1, viewLoadCallableV1, viewLoadBlockV1,
    twoStateCompareInvariantCallableV1, twoStateCompareInvariantBlockV1,
...
theorem callableSignaturesV1
    ...
    validateCallableSignaturePhasesV1 typesV1
      (callablesV1 viewName invariantName) = .ok () := by
  ...
  all_goals
    simp [typesV1, callablesV1, initializerStoreZeroTwoCallableV1,
      ...
      validateInvariantRootStepsPresenceV1, hnames, hInitInit, hViewInit,
      hInvInit, hInitInv, hViewInv, hInvInv, hPublic,
      Pure.pure, Except.pure, Bind.bind, Except.bind]

theorem invariantDeclarationJoinV1
    (viewName invariantName : String) :
    validateInvariantDeclarationJoinV1 (callablesV1 viewName invariantName)
  ...
  simp [callablesV1, initializerStoreZeroTwoCallableV1,
    initializerStoreZeroTwoBlockV1, viewLoadCallableV1, viewLoadBlockV1,
    twoStateCompareInvariantCallableV1, twoStateCompareInvariantBlockV1,
    validateInvariantDeclarationJoinV1, hInitInv, hViewInv, hInvInv,
    Pure.pure, Except.pure, Bind.bind, Except.bind]
...
theorem declarationIdentifierNamesV1
  ...
  simp [subjectDataV1, typesV1, callablesV1,
    ...
    twoStateCompareInvariantCallableV1, twoStateCompareInvariantBlockV1,
    validateDeclarationIdentifierNamesV1,
    validateTypeShapeIdentifierNamesV1, hstate0, hstate1, hview, hinvariant,
    Pure.pure, Except.pure, Bind.bind, Except.bind]
...
theorem genericCfgPhasesV1
  ...
  · exact initializerCfgV1 qualifiedName state0Name state1Name viewName
      invariantName
  · exact viewCfgV1 qualifiedName state0Name state1Name viewName invariantName
  · exact invariantCfgV1 qualifiedName state0Name state1Name viewName
      invariantName
  · rfl

def closureMembersV1 : Array Bool := #[false, false, true]

theorem invariantClosurePhasesV1
    (viewName invariantName : String) :
    validateInvariantClosurePhasesV1
      (callablesV1 viewName invariantName) = .ok closureMembersV1 := by
...
theorem invariantFuelPhasesV1
    ...
    validateInvariantFuelPhasesV1
      (callablesV1 viewName invariantName) closureMembersV1 = .ok () := by
  rfl
...
theorem cfgInvariantPhasesV1
  ...
  apply validateCfgInvariantPhasesV1_eq_ok
    (subjectDataV1 qualifiedName state0Name state1Name viewName invariantName)
    closureMembersV1
  · exact genericCfgPhasesV1 qualifiedName state0Name state1Name viewName
      invariantName
  · simpa [subjectDataV1] using
      invariantClosurePhasesV1 viewName invariantName
  · simpa [subjectDataV1] using
...
theorem structureV1
    (qualifiedName : QualifiedName)
    (state0Name state1Name viewName invariantName : String)
    (legal : StructureLegalV1 qualifiedName state0Name state1Name viewName
      invariantName) :
  ...
  · exact structurePreludeV1 qualifiedName state0Name state1Name viewName
  ...
  · simpa [data, subjectDataV1] using
      callablesValueBytesV1 viewName invariantName
  · exact constantNamesV1 qualifiedName state0Name state1Name viewName
      invariantName
  · simpa [data, subjectDataV1] using
  ...
  · simp [data, subjectDataV1, validateInterfaceFieldNameUniquenessV1,
      Pure.pure, Except.pure, Bind.bind, Except.bind]
  · simpa [data, subjectDataV1] using
      callableSignaturesV1 viewName invariantName legal.hviewInvariant
  · simpa [data, subjectDataV1] using
      invariantDeclarationJoinV1 viewName invariantName
  · exact declarationIdentifierNamesV1 qualifiedName state0Name state1Name
      viewName invariantName legal.hstate0Name legal.hstate1Name
      legal.hviewName legal.hinvariantName
  · exact cfgInvariantPhasesV1 qualifiedName state0Name state1Name viewName
      invariantName
  ...
  · exact (emptyOperationRequirementsV1 qualifiedName state0Name state1Name
      viewName invariantName).1
  · exact (emptyOperationRequirementsV1 qualifiedName state0Name state1Name
      viewName invariantName).2.1
  · exact (emptyOperationRequirementsV1 qualifiedName state0Name state1Name
      viewName invariantName).2.2
...
end ProofForgeV2.Semantic.InitializerViewEqualitySubjectV1
