...
/-
  ProofForgeV2.Semantic.InvariantABI — D2-07 LogicalState / StateConforms foundation.

  Owning module for `LogicalStateV1`, default/initial state construction, and
  `StateConformsV1` (SPEC-SEM-WIRE-001 §7, SPEC-SEM-CORE-001 init contract).
