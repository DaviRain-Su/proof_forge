/-
  CosmWasm engineering finalization adapter (D3/S7b).
  ...
  Separate from pure `Targets.CosmWasm` Plan/IR core (no tool runner in CosmWasm.lean).
...
namespace ProofForgeV2.Targets.CosmWasm.FinalizeV1
...
/-- Exact CosmWasm wat2wasm finalization: produce `{programName}.wasm` under stagingDir.
...
end ProofForgeV2.Targets.CosmWasm.FinalizeV1
