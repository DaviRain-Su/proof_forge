/-
  ...
  Pins canonical root bytes and engineering root digest for the frozen 10-target
...
/-- Frozen 11-target seed engineering root bytes (exact pin). Length 1792. -/
private def expectedRootHexV1 : String :=
  ""

/-- Engineering root digest pin: domainSeparatedSha256(domain, rootBytes). -/
private def expectedDigestWireV1 : String :=
  "sha256:1a4f8c3043b238a9b44aa7c1d009b5039eb4d27a34a32c070be2fd6cd4176143"
...
private def testCanonicalBytesGolden : IO Unit := do
  ...
  expect (bytes.size == 1792) s!"root byte length: got {bytes.size}"
  expect (hex == expectedRootHexV1) "canonical root bytes golden pin"
  -- Count header is little-endian 11.
  expect (bytes.get! 0 == 11) "u32le registration count low byte"
...
private def testTamperMatrix : IO Unit := do
  ...
  expect (withoutLast.size == 10) "drop one registration"
