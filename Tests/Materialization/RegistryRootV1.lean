...
/-- Frozen 10-target seed engineering root bytes (exact pin). Length 1618. -/
private def expectedRootHexV1 : String :=
  ""

/-- Engineering root digest pin: domainSeparatedSha256(domain, rootBytes). -/
private def expectedDigestWireV1 : String :=
  "sha256:250645bd28074637105ecc3b3de86f5d60b588766af392180a5280215f133590"
...
private def testCanonicalBytesGolden : IO Unit := do
  ...
  expect (bytes.size == 1618) s!"root byte length: got {bytes.size}"
  let hex := encodeLowerHex bytes
  expect (hex == expectedRootHexV1) "canonical root bytes golden pin"
  -- Count header is little-endian 10.
  expect (bytes.get! 0 == 10) "u32le registration count low byte"
...
private def testTamperMatrix : IO Unit := do
  ...
  expect (withoutLast.size == 9) "drop one registration"
