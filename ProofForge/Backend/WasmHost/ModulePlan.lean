...
inductive OpPlan where
  ...
  | memoryAlloc (result : ValuePlan) (elementType : ValueType) (length : ValuePlan)
  | memoryLoad (result base index : ValuePlan) (elementType : ValueType)
  | memoryStore (base index value : ValuePlan) (elementType : ValueType)
  | memoryRelease (base : ValuePlan) (elementType : ValueType)
