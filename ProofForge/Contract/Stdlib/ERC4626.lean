...
def assetAddress : ScalarRef :=
  ProofForge.Contract.Source.Legacy.slot "asset" .address

def vaultSelf : ScalarRef :=
  ProofForge.Contract.Source.Legacy.slot "vaultSelf" .address
...
def requireU64Result (value : ProofForge.IR.Expr) (message : String) : EntryM Unit :=
  ProofForge.Contract.Source.Legacy.requireGe
    (ProofForge.Contract.Source.Legacy.u64 0xffffffffffffffff) value message

def addressWord (value : ProofForge.IR.Expr) : ProofForge.IR.Expr :=
  ProofForge.Contract.Source.Legacy.cast value .u64
...
def requireRemoteTrue (name : String) (value : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  ProofForge.Contract.Source.Legacy.requireEq
    (ProofForge.Contract.Builder.localVar name)
    (ProofForge.Contract.Source.Legacy.u64 1)
    "ERC20 operation returned false"

def requireFeeRecipientWhenEnabled
    (bps recipient : ProofForge.IR.Expr) : EntryM Unit :=
  ProofForge.Contract.Source.Legacy.whenPositive bps do
    ProofForge.Contract.Source.Legacy.requireNonZero recipient "zero feeRecipient"
...
def applyConvertToShares (amount : ProofForge.IR.Expr) : EntryM Unit := do
  let ts := ProofForge.Contract.Source.Legacy.read totalSupply
...
def applyConvertToSharesUp (amount : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  ProofForge.Contract.Source.Legacy.whenPositive ts do
    ...
    ProofForge.Contract.Builder.letBind "_pf_shares_up_numerator" .u64
      (ProofForge.Contract.Source.Legacy.mul amount ts)
    ...
    ProofForge.Contract.Builder.letBind "_pf_shares_up_quotient" .u64
      (ProofForge.Contract.Source.Legacy.div numerator ta)
    ...
    ProofForge.Contract.Source.Legacy.write convertScratch
      quotient
    ProofForge.Contract.Source.Legacy.whenPositive (ProofForge.Contract.Builder.mod numerator ta) do
      ProofForge.Contract.Source.Legacy.requireNe quotient
        (ProofForge.Contract.Source.Legacy.u64 0xffffffffffffffff)
        "withdraw share quote overflow"
      ProofForge.Contract.Source.Legacy.write convertScratch
        (ProofForge.Contract.Source.Legacy.add
          quotient
          (ProofForge.Contract.Source.Legacy.u64 1))
...
def applyConvertToAssetsUp (amount : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  ProofForge.Contract.Source.Legacy.whenPositive ts do
    ...
    ProofForge.Contract.Builder.letBind "_pf_assets_up_numerator" .u64
      (ProofForge.Contract.Source.Legacy.mul amount ta)
    ...
    ProofForge.Contract.Builder.letBind "_pf_assets_up_quotient" .u64
      (ProofForge.Contract.Source.Legacy.div numerator ts)
    ...
    ProofForge.Contract.Source.Legacy.write convertScratch
      quotient
    ProofForge.Contract.Source.Legacy.whenPositive (ProofForge.Contract.Builder.mod numerator ts) do
      ProofForge.Contract.Source.Legacy.requireNe quotient
        (ProofForge.Contract.Source.Legacy.u64 0xffffffffffffffff)
...
def applyEntryFee : EntryM Unit := do
  let gross := ProofForge.Contract.Source.Legacy.read convertScratch
  let bps := ProofForge.Contract.Source.Legacy.read feeBps
  ProofForge.Contract.Source.Legacy.write feeScratch (ProofForge.Contract.Source.Legacy.u64 0)
  ProofForge.Contract.Source.Legacy.whenPositive bps do
    ProofForge.Contract.Source.Legacy.write feeScratch
      (ProofForge.Contract.Source.Legacy.div
        (ProofForge.Contract.Source.Legacy.mul gross bps)
        (ProofForge.Contract.Source.Legacy.u64 10000))
    ProofForge.Contract.Source.Legacy.write convertScratch
      (ProofForge.Contract.Source.Legacy.sub gross
        (ProofForge.Contract.Source.Legacy.read feeScratch))
...
def applyGrossFromNetShares : EntryM Unit := do
  let net := ProofForge.Contract.Source.Legacy.read convertScratch
  let bps := ProofForge.Contract.Source.Legacy.read feeBps
  ProofForge.Contract.Source.Legacy.whenPositive bps do
    ProofForge.Contract.Source.Legacy.requireNe bps (ProofForge.Contract.Source.Legacy.u64 10000)
      "feeBps 10000 blocks mint"
    let denom :=
      ProofForge.Contract.Source.Legacy.sub (ProofForge.Contract.Source.Legacy.u64 10000) bps
    ProofForge.Contract.Source.Legacy.write convertScratch
      (ProofForge.Contract.Source.Legacy.div
        (ProofForge.Contract.Source.Legacy.mul net (ProofForge.Contract.Source.Legacy.u64 10000))
        denom)
  ...
  ProofForge.Contract.Source.Legacy.whenPositive ts do
    ...
    ProofForge.Contract.Source.Legacy.whenPositive (ProofForge.Contract.Builder.mod numerator ta) do
      ProofForge.Contract.Source.Legacy.requireNe quotient
        ...
        "withdraw share quote overflow"
      ProofForge.Contract.Builder.assign (.local name)
        (ProofForge.Contract.Source.Legacy.add quotient (ProofForge.Contract.Source.Legacy.u64 1))
  pure (.local name)
...
def capLocalForCheckedMul (name : String) (multiplicand : ProofForge.IR.Expr) : EntryM Unit :=
  ProofForge.Contract.Source.Legacy.whenPositive multiplicand do
    capLocalU64 name
      (ProofForge.Contract.Source.Legacy.div
        (ProofForge.Contract.Source.Legacy.u64 0xffffffffffffffff)
        multiplicand)
...
def feeLimitsUsable : ProofForge.IR.Expr :=
  let bps := ProofForge.Contract.Source.Legacy.read feeBps
  let recipient := ProofForge.Contract.Source.Legacy.read feeRecipient
  ProofForge.Contract.Builder.boolAnd
    (ProofForge.Contract.Builder.lt bps (ProofForge.Contract.Source.Legacy.u64 10000))
    (ProofForge.Contract.Builder.boolOr
      (ProofForge.Contract.Builder.eq bps (ProofForge.Contract.Source.Legacy.u64 0))
      (ProofForge.Contract.Builder.ne recipient
        (ProofForge.Contract.Source.Legacy.cast (ProofForge.Contract.Source.Legacy.u64 0) .address)))
...
def localMaxDeposit (name : String) (receiver : ProofForge.IR.Expr) :
    EntryM ProofForge.IR.Expr := do
  let max := ProofForge.Contract.Source.Legacy.u64 0xffffffffffffffff
  let zero := ProofForge.Contract.Source.Legacy.u64 0
  ProofForge.Contract.Builder.letMutBind name .u64 zero
  whenCondition (ProofForge.Contract.Builder.ne receiver (ProofForge.Contract.Source.Legacy.u64 0)) do
    whenCondition feeLimitsUsable do
      let ta := ProofForge.Contract.Source.Legacy.read totalAssetsSlot
      let ts := ProofForge.Contract.Source.Legacy.read totalSupply
      let assetCapName := name ++ "_asset_cap"
      ProofForge.Contract.Builder.letMutBind assetCapName .u64
        (ProofForge.Contract.Source.Legacy.sub max ta)
      ...
      ProofForge.Contract.Builder.letMutBind (name ++ "_gross_cap") .u64
        (ProofForge.Contract.Source.Legacy.sub max ts)
      let grossCapName := name ++ "_gross_cap"
      capLocalU64 grossCapName
        (ProofForge.Contract.Source.Legacy.sub max
          (ProofForge.Contract.Source.Legacy.mapGet shareBalances receiver))
      let bps := ProofForge.Contract.Source.Legacy.read feeBps
      ProofForge.Contract.Source.Legacy.whenPositive bps do
        capLocalU64 grossCapName
          (ProofForge.Contract.Source.Legacy.sub max
            (ProofForge.Contract.Source.Legacy.mapGet shareBalances
              (addressWord (ProofForge.Contract.Source.Legacy.read feeRecipient))))
      ...
      ProofForge.Contract.Source.Legacy.whenZero ts do
        capLocalU64 name grossCap
      ProofForge.Contract.Source.Legacy.whenPositive ts do
        ProofForge.Contract.Source.Legacy.whenZero ta do
          assignLocalU64 name zero
        ProofForge.Contract.Source.Legacy.whenPositive ta do
          ProofForge.Contract.Builder.letBind (name ++ "_gross_at_asset_cap") .u64
            (ProofForge.Contract.Source.Legacy.div
              (ProofForge.Contract.Source.Legacy.mul assetCap ts) ta)
          let grossAtAssetCap :=
          ...
          whenCondition (ProofForge.Contract.Builder.gt grossAtAssetCap grossCap) do
            ...
            assignLocalU64 name
              (ProofForge.Contract.Source.Legacy.div
                (ProofForge.Contract.Source.Legacy.mul
                  (ProofForge.Contract.Builder.localVar reverseGrossName) ta) ts)
          ProofForge.Contract.Builder.letBind (name ++ "_gross_final") .u64
            (ProofForge.Contract.Source.Legacy.div
              (ProofForge.Contract.Source.Legacy.mul (.local name) ts) ta)
          ProofForge.Contract.Source.Legacy.whenZero (.local (name ++ "_gross_final")) do
            assignLocalU64 name zero
  pure (.local name)
    ...
    whenCondition feeLimitsUsable do
      ...
      ProofForge.Contract.Source.Legacy.whenPositive ts do
        ...
        ProofForge.Contract.Source.Legacy.whenPositive ta do
          ...
          ProofForge.Contract.Builder.letBind (name ++ "_gross_from_asset_cap") .u64
            (ProofForge.Contract.Source.Legacy.div
              (ProofForge.Contract.Source.Legacy.mul (.local assetCapName) ts) ta)
          capLocalU64 grossCapName (.local (name ++ "_gross_from_asset_cap"))
      ProofForge.Contract.Source.Legacy.whenZero bps do
      ...
      ProofForge.Contract.Source.Legacy.whenPositive bps do
        ...
        localNetAfterFee (name ++ "_net_cap") (.local grossCapName) >>= fun netCap => do
          ...
          capLocalForCheckedMul name (ProofForge.Contract.Source.Legacy.u64 10000)
...
def localMaxExit (name : String) (holder : ProofForge.IR.Expr) (redeem : Bool) :
  ...
  whenCondition feeLimitsUsable do
    ...
    ProofForge.Contract.Builder.letMutBind sharesName .u64
      (ProofForge.Contract.Source.Legacy.mapGet shareBalances holder)
    capLocalU64 sharesName (ProofForge.Contract.Source.Legacy.read totalSupply)
    let ts := ProofForge.Contract.Source.Legacy.read totalSupply
    let ta := ProofForge.Contract.Source.Legacy.read totalAssetsSlot
    ProofForge.Contract.Source.Legacy.whenPositive ts do
      ProofForge.Contract.Source.Legacy.whenPositive ta do
        ...
        ProofForge.Contract.Builder.letMutBind grossName .u64
          (ProofForge.Contract.Source.Legacy.div
            (ProofForge.Contract.Source.Legacy.mul (.local sharesName) ta) ts)
        let bps := ProofForge.Contract.Source.Legacy.read feeBps
        if redeem then
          ProofForge.Contract.Source.Legacy.whenPositive bps do
            let grossFeeCapName := name ++ "_gross_fee_cap"
            ProofForge.Contract.Builder.letMutBind grossFeeCapName .u64
              (ProofForge.Contract.Source.Legacy.div max bps)
            whenCondition
              ...
              assignLocalU64 sharesName
                (ProofForge.Contract.Source.Legacy.div
                  (ProofForge.Contract.Source.Legacy.mul (.local grossFeeCapName) ts) ta)
        ...
        localNetAfterFee (name ++ "_net_assets") (.local grossName) >>= fun netAssets =>
          ProofForge.Contract.Source.Legacy.whenPositive netAssets do
...
def mintFeeSharesIfAny : EntryM Unit := do
  let fee := ProofForge.Contract.Source.Legacy.read feeScratch
  ProofForge.Contract.Source.Legacy.whenPositive fee do
    let recip := ProofForge.Contract.Source.Legacy.read feeRecipient
    ProofForge.Contract.Source.Legacy.requireNonZero (addressWord recip) "zero feeRecipient"
    let recipKey := addressWord recip
    let bal :=
      ProofForge.Contract.Source.Legacy.mapGet shareBalances recipKey
    ProofForge.Contract.Source.Legacy.mapSet shareBalances recipKey
      (ProofForge.Contract.Source.Legacy.add bal fee)
    ProofForge.Contract.Source.Legacy.emitIndexed (ProofForge.Contract.Source.Legacy.event "Transfer")
      #[
        ProofForge.Contract.Source.Legacy.fieldAsName "from" (ProofForge.Contract.Source.Legacy.u64 0),
        ProofForge.Contract.Source.Legacy.fieldAsName "to" (addressWord recip)
      ]
      #[ProofForge.Contract.Source.Legacy.fieldAsName "value" fee]

/-- Snapshot `balanceOf(vaultSelf)` into `balanceScratch` (exit FOT measure start). -/
def beginVaultAssetMeasure : EntryM Unit := do
  let assetTok := addressWord (ProofForge.Contract.Source.Legacy.read assetAddress)
  let selfAddr := addressWord (ProofForge.Contract.Source.Legacy.read vaultSelf)
  let before :=
    ProofForge.Contract.Source.Legacy.remoteCall assetTok
      (ProofForge.Contract.Source.Legacy.u64 ierC20BalanceOfSelector) #[selfAddr]
  ProofForge.Contract.Source.Legacy.write balanceScratch before
...
def endVaultAssetMeasure : EntryM Unit := do
  ...
  ProofForge.Contract.Source.Legacy.write actualAssetsScratch
    (ProofForge.Contract.Source.Legacy.sub
      (ProofForge.Contract.Source.Legacy.read balanceScratch)
      (ProofForge.Contract.Builder.localVar "_pf_bal_after_push"))
  ProofForge.Contract.Source.Legacy.requireNonZero
    (ProofForge.Contract.Source.Legacy.read actualAssetsScratch) "zero actual assets left vault"
...
def pushExitFeeAssetsIfAny : EntryM Unit := do
  ...
  ProofForge.Contract.Source.Legacy.whenPositive fee do
    ...
    let sent :=
      ProofForge.Contract.Source.Legacy.remoteCall assetTok
        (ProofForge.Contract.Source.Legacy.u64 ierC20TransferSelector)
...
def pullAssetsMeasuring (amount : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  let pulled :=
    ProofForge.Contract.Source.Legacy.remoteCall assetTok
      (ProofForge.Contract.Source.Legacy.u64 ierC20TransferFromSelector)
      #[ProofForge.Contract.Source.Legacy.caller, selfAddr, amount]
  ...
  ProofForge.Contract.Source.Legacy.write actualAssetsScratch
    (ProofForge.Contract.Source.Legacy.sub
      ...
      (ProofForge.Contract.Source.Legacy.read balanceScratch))
  ProofForge.Contract.Source.Legacy.requireNonZero
    (ProofForge.Contract.Source.Legacy.read actualAssetsScratch) "zero actual assets"
...
def pushAssets (recipient amount : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  let sent :=
    ProofForge.Contract.Source.Legacy.remoteCall assetTok
      (ProofForge.Contract.Source.Legacy.u64 ierC20TransferSelector) #[recipient, amount]
...
def pushAssetsMeasuringRecv (recipient amount : ProofForge.IR.Expr) : EntryM Unit := do
  ...
  let before :=
    ProofForge.Contract.Source.Legacy.remoteCall assetTok
      (ProofForge.Contract.Source.Legacy.u64 ierC20BalanceOfSelector) #[recipient]
  ProofForge.Contract.Source.Legacy.write recvBalScratch before
  let sent :=
    ProofForge.Contract.Source.Legacy.remoteCall assetTok
      (ProofForge.Contract.Source.Legacy.u64 ierC20TransferSelector) #[recipient, amount]
  ...
  ProofForge.Contract.Source.Legacy.write recvActualScratch
    (ProofForge.Contract.Source.Legacy.sub
      (ProofForge.Contract.Builder.localVar "_pf_recv_after")
      (ProofForge.Contract.Source.Legacy.read recvBalScratch))

contract_mixin ERC4626Mixin do
  use ProofForge.Contract.Source.Legacy.scalar assetAddress
  use ProofForge.Contract.Source.Legacy.scalar vaultSelf
  ...
  use ProofForge.Contract.Source.Legacy.scalar feeScratch
  use ProofForge.Contract.Source.Legacy.scalar balanceScratch
  use ProofForge.Contract.Source.Legacy.scalar actualAssetsScratch
  use ProofForge.Contract.Source.Legacy.scalar recvBalScratch
  use ProofForge.Contract.Source.Legacy.scalar recvActualScratch
  use ProofForge.Contract.Source.Legacy.scalar feeBps
  use ProofForge.Contract.Source.Legacy.scalar feeRecipient
  use ProofForge.Contract.Source.Legacy.scalar erc4626Lock
  use ProofForge.Contract.Source.Legacy.scalar initialized
  use ProofForge.Contract.Source.Legacy.mapState shareBalances
  use ProofForge.Contract.Source.Legacy.mapState shareAllowances
  ...
  query convertToShares (assets : .u64) returns(.u64) do
    do localConvertToShares "_pf_convert_shares" (ProofForge.Contract.Source.Legacy.ref assets) >>=
      ProofForge.Contract.Builder.ret;

  query convertToAssets (shares : .u64) returns(.u64) do
    do localConvertToAssets "_pf_convert_assets" (ProofForge.Contract.Source.Legacy.ref shares) >>=
      ProofForge.Contract.Builder.ret;

  query maxDeposit (who : .address) returns(.u64) do
    do localMaxDeposit "_pf_max_deposit" (ProofForge.Contract.Source.Legacy.ref who) >>=
      ProofForge.Contract.Builder.ret;

  query maxMint (who : .address) returns(.u64) do
    do localMaxMint "_pf_max_mint" (ProofForge.Contract.Source.Legacy.ref who) >>=
      ProofForge.Contract.Builder.ret;

  query maxWithdraw (holder : .address) returns(.u64) do
    do localMaxExit "_pf_max_withdraw" (ProofForge.Contract.Source.Legacy.ref holder) false >>=
      ProofForge.Contract.Builder.ret;

  query maxRedeem (holder : .address) returns(.u64) do
    do localMaxExit "_pf_max_redeem" (ProofForge.Contract.Source.Legacy.ref holder) true >>=
      ProofForge.Contract.Builder.ret;
  ...
  query previewDeposit (assets : .u64) returns(.u64) do
    do localConvertToShares "_pf_preview_deposit" (ProofForge.Contract.Source.Legacy.ref assets) >>=
  ...
  query previewMint (shares : .u64) returns(.u64) do
    ...
    do localGrossFromNetShares "_pf_preview_mint_gross"
      (ProofForge.Contract.Source.Legacy.ref shares) >>= fun gross =>
  ...
  query previewWithdraw (assets : .u64) returns(.u64) do
    ...
    do localConvertToSharesUp "_pf_preview_withdraw" (ProofForge.Contract.Source.Legacy.ref assets) >>=
      ProofForge.Contract.Builder.ret;

  query previewRedeem (shares : .u64) returns(.u64) do
    -- net assets user receives after exit fee
    do localConvertToAssets "_pf_preview_redeem" (ProofForge.Contract.Source.Legacy.ref shares) >>=
  ...
  entry deposit (assets : .u64, receiver : .address) returns(.u64) do
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref receiver)
      "zero receiver";
    ...
    do pullAssetsMeasuring (ProofForge.Contract.Source.Legacy.ref assets);
    let actual : .u64 := actualAssetsScratch;
    convertScratch := actual;
    do applyConvertToShares (ProofForge.Contract.Source.Legacy.ref actual);
    let gross : .u64 := convertScratch;
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref gross)
      "zero shares";
    do applyEntryFee;
  ...
  entry mint (shares : .u64, receiver : .address) returns(.u64) do
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref grossWanted)
      "zero gross shares";
    convertScratch := grossWanted;
    do applyConvertToAssetsUp (ProofForge.Contract.Source.Legacy.ref grossWanted);
    let assetsWanted : .u64 := convertScratch;
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref assetsWanted)
      "zero assets";
    do pullAssetsMeasuring (ProofForge.Contract.Source.Legacy.ref assetsWanted);
    let actual : .u64 := actualAssetsScratch;
    convertScratch := actual;
    do applyConvertToShares (ProofForge.Contract.Source.Legacy.ref actual);
    let grossAvailable : .u64 := convertScratch;
    do ProofForge.Contract.Source.Legacy.requireGe (ProofForge.Contract.Source.Legacy.ref grossAvailable)
      (ProofForge.Contract.Source.Legacy.ref grossWanted) "insufficient actual assets";
  ...
  entry withdraw (assets : .u64, receiver : .address, holder : .address) returns(.u64) do
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref assets)
      "zero assets";
    do ProofForge.Contract.Source.Legacy.requireEq caller (ProofForge.Contract.Source.Legacy.ref holder)
      "not holder";
    -- Plan shares / net user assets from requested `assets` (exit fee skim)
    convertScratch := assets;
    do applyConvertToSharesUp (ProofForge.Contract.Source.Legacy.ref assets);
    let shares : .u64 := convertScratch;
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref shares)
      "zero shares";
    convertScratch := assets;
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref userAssets)
      "zero net assets";
    let ownerBal : .u64 := mapRead shareBalances holder;
    do ProofForge.Contract.Source.Legacy.requireGe (ProofForge.Contract.Source.Legacy.ref ownerBal)
    ...
    do pushAssetsMeasuringRecv (ProofForge.Contract.Source.Legacy.ref receiver)
      (ProofForge.Contract.Source.Legacy.ref userAssets);
    ...
    do ProofForge.Contract.Source.Legacy.requireGe
      (ProofForge.Contract.Source.Legacy.read totalAssetsSlot)
      (ProofForge.Contract.Source.Legacy.ref actualLeft) "actual left > totalAssets";
    let ta : .u64 := totalAssetsSlot;
  ...
  entry redeem (shares : .u64, receiver : .address, holder : .address) returns(.u64) do
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref grossAssets)
      "zero assets";
  ...
  entry transfer (recipient : .address, amount : .u64) returns(.bool) do
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref recipient)
      "zero recipient";
  ...
  entry approve (spender : .address, amount : .u64) returns(.bool) do
    ...
    do ProofForge.Contract.Source.Legacy.requireNonZero (ProofForge.Contract.Source.Legacy.ref spender)
      "zero spender";
    do pathWriteAllowance shareAllowances (ProofForge.Contract.Source.Legacy.ref holder)
      (ProofForge.Contract.Source.Legacy.ref spender) amount;
...
contract_source ERC4626 do
  ...
  entry init (assetAddr : .address, selfAddr : .address,
    ...
    do ProofForge.Contract.Source.Legacy.requireEq
      (ProofForge.Contract.Source.Legacy.read initialized) (u64 0) "already initialized";
    initialized := u64 1;
    do ProofForge.Contract.Source.Legacy.requireNonZero
      (ProofForge.Contract.Source.Legacy.ref assetAddr) "zero asset";
    do ProofForge.Contract.Source.Legacy.requireEq
      (ProofForge.Contract.Source.Legacy.cast (ProofForge.Contract.Source.Legacy.ref selfAddr) .address)
      (ProofForge.Contract.Source.Legacy.cast ProofForge.Contract.Source.Legacy.contractId .address)
      "vaultSelf != contractId";
    do ProofForge.Contract.Source.Legacy.requireGe (u64 10000)
      (ProofForge.Contract.Source.Legacy.ref feeBpsVal) "feeBps > 10000";
    do requireFeeRecipientWhenEnabled
      (ProofForge.Contract.Source.Legacy.ref feeBpsVal)
      (ProofForge.Contract.Source.Legacy.ref feeRecipientAddr);
    assetAddress := ProofForge.Contract.Source.Legacy.cast
      (ProofForge.Contract.Source.Legacy.ref assetAddr) .address;
    vaultSelf := ProofForge.Contract.Source.Legacy.cast
      (ProofForge.Contract.Source.Legacy.ref selfAddr) .address;
    feeBps := feeBpsVal;
    feeRecipient := ProofForge.Contract.Source.Legacy.cast
      (ProofForge.Contract.Source.Legacy.ref feeRecipientAddr) .address;
