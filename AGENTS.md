...
| Active development slice | **D1-PA-15 / TASK-D1-03 pre-acceptance**：`UInt8/16/32/128/256` 与 `Int8/16/32/64/128/256` declaration type carrier、append-only canonical binding 与双入口 parity |
| Next development slice | **D1-PA-16 / TASK-D1-03 pre-acceptance**：`Unit` carrier 与 omitted return type materialization |
