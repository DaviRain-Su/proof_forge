...
| Active development slice | **D1-PA-32 / TASK-D1-04 pre-acceptance**：shift-right `>>` Source-only carrier；完成面已冻结，下一步提交 RED |
| Next development slice | 未冻结；D1-PA-32 收口后形成 ShiftExpr Source batch checkpoint，先执行一次完整 CI 再选下一 slice |
