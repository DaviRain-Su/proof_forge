...
| A-CUT2 | in_progress (A-CUT2a-A-CUT2e-d verified) | Independent Authored syntax now covers typed effects, storage/memory lifecycle, crosscalls, struct semantics/layout, and verification evidence; Source builder/loader cutover remains pending |
