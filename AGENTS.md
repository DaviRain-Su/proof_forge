...
| Active development slice | 无；**D1-PA-42 / TASK-D1-04 pre-acceptance** binary logical-and Source-only carrier 已收口 |
| Next development slice | **D1-PA-43 candidate**：binary logical-or Source-only carrier；尚未冻结，禁止自动递增 |
