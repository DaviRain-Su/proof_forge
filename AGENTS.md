...
| Active development slice | 无；D1-PA-49 已作为 development evidence 收口，尚未冻结新的 pre-acceptance slice |
| Next development slice | 未冻结；先做 expression residual audit，再选择单一依赖闭合的最小 slice，禁止自动递增 |
