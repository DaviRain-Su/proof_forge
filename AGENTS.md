...
| Active development slice | 无；**D1-PA-40 / TASK-D1-04 pre-acceptance** binary bitwise-xor `^` Source-only carrier 已收口 |
| Next development slice | **D1-PA-41 candidate**：binary bitwise-or Source-only carrier；尚未冻结，必须先核准 enum/match-arm token boundary |
