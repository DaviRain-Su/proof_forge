...
| Active development slice | **D1-PA-10 / TASK-D1-03 pre-acceptance**：invariant declaration carrier、canonical expression binding 与 duplicate/fail-closed boundary |
| Next development slice | **D1-PA-11 / TASK-D1-03 pre-acceptance**：extension requirement carrier、exact version/digest binding 与 duplicate/fail-closed boundary |
