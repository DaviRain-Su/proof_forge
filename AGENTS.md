...
| Active task | A-CUT3/CMP-3 - ValueVault authoring and all three native references are pinned; implement the fail-closed primary-triad VM runner |
...
| Validation track | CMP-0 is done at `18f15e59`; CMP-1 at `7fee238c`; A-CUT2/CMP-2 at `e2834c59`; CMP-3 has a 13-step scenario plus pinned Solidity, Pinocchio, and near-sdk references, still without semantic promotion |
