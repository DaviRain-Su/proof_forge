...
| Active development slice | 无；D1-PA-27 unary bitwise-not `~` Source-only carrier 已以 `EV-20260718-0013` 完成 development 收口 |
| Next development slice | **D1-PA-28 candidate / TASK-D1-04 pre-acceptance**：unary logical-not `!` Source-only carrier；尚未冻结，必须先完成 Bool/unary/canonical audit |
