...
| Active development slice | **D1-PA-79 / TASK-D1-03 pre-acceptance**：exact `Option Option Array Bytes N M` existing-carrier spelling；完成面已冻结，下一步提交 tests-only RED |
| Next development slice | 未冻结；D1-PA-79 收口后再按 residual audit 选择单一 slice，禁止自动递增 |
