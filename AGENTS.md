...
| Active development slice | **D1-PA-80 / TASK-D1-03 pre-acceptance**：exact `Array Option Option Bytes N M` existing-carrier spelling；完成面已冻结，下一步提交 tests-only RED |
| Next development slice | 未冻结；D1-PA-80 收口后先确认 fixed-leaf family closure，再选择是否继续 residual，禁止自动递增 |
