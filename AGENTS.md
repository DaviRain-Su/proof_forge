...
| Gate | A1 - Portable Intent and NFT vertical slice (open) |
...
|---|---|---|---|
| A1 | pending | Isolate Solana grammar ownership | Plan Task 1 |
| A2 | pending after A1 | Add the intent materializer contract | Plan Task 2 |
