...
| Active development slice | D1-PA-67 exact `Option Array Option PrimitiveAtom N` existing-carrier spelling；冻结后只改 Syntax 与 tests RED，formal TASK-D1-03 仍 pending |
