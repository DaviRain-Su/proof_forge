...
| A-CUT2 | in_progress (through A-CUT2f-a verified) | The independent Authored schema and direct `Frontend.Authored.Builder` now produce checked Canonical Core without `Contract.Builder`; public Source/loader cutover remains pending |
