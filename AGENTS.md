...
| Active development slice | 无；D1-PA-26 bare `assert Expr` Source-only statement carrier 已以 `EV-20260718-0012` 完成 development 收口 |
| Next development slice | **D1-PA-27 candidate / TASK-D1-04 pre-acceptance**：unary bitwise-not `~` Source-only carrier；尚未冻结，必须先完成 unary/canonical/scope audit |
