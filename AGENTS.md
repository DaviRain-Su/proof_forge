...
| EVM-R2 | in_progress (core + policy + aggregate/local-array + context + Escrow verified 2026-07-14) | Materialize Counter, ValueVault, Token, RemoteCall, and remaining EVM product families directly into checked Canonical Core |
