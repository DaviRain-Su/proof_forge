...
| Active development slice | D1-PA-68 exact `Option Array Bytes N M` existing-carrier spelling；冻结后只改 Syntax 与 tests RED，formal TASK-D1-03 仍 pending |
| Next development slice | PA-68 收口后重新做 residual audit；禁止由 checkpoint 自动递增 |
