...
| Active task | EVM-R2 - materialize EVM product families directly into checked Canonical Core |
...
| EVM-R2 | in_progress (core + policy + aggregate/context + four vault/accounting products verified 2026-07-14) | Materialize Counter, ValueVault, Token, RemoteCall, and remaining EVM product families directly into checked Canonical Core |
