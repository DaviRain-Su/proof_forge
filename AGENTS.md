...
| EVM-R2 | in_progress (Counter + ValueVault + RemoteCall + Token + Ownable verified 2026-07-14) | Materialize Counter, ValueVault, Token, RemoteCall, and remaining EVM product families directly into checked Canonical Core |
