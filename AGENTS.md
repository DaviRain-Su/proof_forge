...
| Active development slice | **D1-PA-25 / TASK-D1-04 pre-acceptance**：unary checked negation Source-only carrier；完成面已冻结，下一步提交 RED 与既有 unary-negative pin migration |
| Next development slice | 未冻结；D1-PA-25 收口后再按 statement/expression residual audit 选择单一 slice，禁止由 checkpoint 自动递增 |
