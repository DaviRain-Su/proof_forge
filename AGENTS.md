...
| Active development slice | **D1-PA-28 / TASK-D1-04 pre-acceptance**：unary logical-not `!` Source-only carrier；完成面已冻结，下一步提交 RED |
| Next development slice | 未冻结；D1-PA-28 收口后形成 unary-expression batch checkpoint，再按 residual audit 选择单一 slice |
