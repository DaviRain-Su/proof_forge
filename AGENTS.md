...
| Active development slice | 无；D1-PA-24 parenthesized expression grouping parser sugar 已以 `EV-20260718-0010` 完成 development 收口 |
| Next development slice | **D1-PA-25 candidate / TASK-D1-04 pre-acceptance**：unary checked negation Source-only carrier；尚未冻结，必须先完成 unary/binary-minus/canonical audit，禁止由 checkpoint 自动递增 |
