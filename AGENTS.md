...
| A-CUT3 | in_progress (Pausable direct cutover verified at `50c1c07a`) | Migrate the full product catalog from the single abstract source; ReentrancyGuard follows CMP-3e evidence |
