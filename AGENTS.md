...
| Active development slice | **D1-PA-45 / TASK-D1-04 pre-acceptance**：完整 LocalFnCall/ExprList Source-only carrier；完成面已冻结，下一步提交 RED |
| Next development slice | 未冻结；D1-PA-45 收口后按 call-like/primary residual audit 选择单一 slice，禁止自动递增 |
