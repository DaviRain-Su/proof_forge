...
| Active development slice | **D1-PA-40 / TASK-D1-04 pre-acceptance**：binary bitwise-xor `^` Source-only carrier；完成面已冻结，下一步提交 RED |
| Next development slice | 未冻结；D1-PA-40 收口后再按 expression residual audit 选择单一 slice，禁止自动递增 |
