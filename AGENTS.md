...
| Active development slice | **D1-PA-18 / TASK-D1-03 pre-acceptance**：spec-first `Option` declaration carrier；先冻结 alpha payload canonical encoding/requirement propagation，再提交 bounded RED |
| Next development slice | 未冻结；D1-PA-18 收口后再按 residual audit 选择单一 type-family slice，禁止由 checkpoint 自动递增 |
