...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.normalizeBody` for canonical CFG conversion." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize` for canonical state resolution." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.adaptType` for canonical type conversion." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.adaptLiteral` for canonical literal conversion." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.adaptAssignOp` for canonical operator conversion." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.adaptContextField` for canonical context conversion." (since := "0.1.0-beta.1")]
...
mutual
  ...
  @[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.normalizeExpr` for canonical ANF conversion." (since := "0.1.0-beta.1")]
  ...
  @[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.normalizeEffect` for canonical effect conversion." (since := "0.1.0-beta.1")]
...
@[deprecated "Legacy elaborator: use `ProofForge.Frontend.Authored.Normalize.normalizeContractSpec` for canonical bundle conversion." (since := "0.1.0-beta.1")]
