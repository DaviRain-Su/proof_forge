# Goal slice — N-3: Commit + disclosure.commit
...
## Objective
Product Commit operator + disclosure.commit requirements; CheckV1/RequirementsInfer as needed; Plans identity pass-through already partial.
...
```json
{
  "slice_id": "N-3",
  "milestone": "D2",
  "objective": "Product Commit operator + disclosure.commit requirements; CheckV1/RequirementsInfer as needed; Plans identity pass-through already partial.",
  "dependencies": ["N-2"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-3): commit-+-disclosure.commit",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
