# Goal slice — N-7: Nested constructor subpatterns
...
## Objective
Full nested constructor patterns in match beyond N-A2 minimum. Tests + fail-closed cases.
...
```json
{
  "slice_id": "N-7",
  "milestone": "D2",
  "objective": "Full nested constructor patterns in match beyond N-A2 minimum. Tests + fail-closed cases.",
  "dependencies": ["N-A2"],
  "allowed_paths": ["ProofForgeV2/Semantic/", "ProofForgeV2/Typed/", "Tests/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-7): nested-constructor-subpatterns",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-7","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
