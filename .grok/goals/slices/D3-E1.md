# Goal slice — D3-E1: Registry root product decision
...
## Phase
`d3` · milestone hint `D2` · shared_cutover `False`

## Objective
Either expose engineering registry root digest on product path or document permanent engineering-only boundary in AGENTS/RECOVERY.
...
```json
{
  "slice_id": "D3-E1",
  "milestone": "D2",
  "objective": "Either expose engineering registry root digest on product path or document permanent engineering-only boundary in AGENTS/RECOVERY.",
  "dependencies": [],
  "allowed_paths": ["ProofForgeV2/Targets/", "docs/", "AGENTS.md", "RECOVERY.md", "docs/engineering-backlog.md"],
  "focused_checks": ["just docs-check", "just test-fast"],
  ...
  "commit_message": "slice(D3-E1): registry-root-product-decision",
  "constraints": "Serial shared-core if Normalize/Typed/Semantic. Never push. Never formal. Update engineering-backlog.md. Product decision may pause."
}
```
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D3-E1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
