# Goal slice — R-2: evalInvariantV1 engineering entry
...
## Phase
`reference` · milestone hint `D2` · shared_cutover `False`

## Objective
Implement engineering evalInvariantV1 / InvariantTheoremV1 entrypoints without claiming formal theorem corpus done.
...
```json
{
  "slice_id": "R-2",
  "milestone": "D2",
  "objective": "Implement engineering evalInvariantV1 / InvariantTheoremV1 entrypoints without claiming formal theorem corpus done.",
  "dependencies": ["R-1"],
  "allowed_paths": ["ProofForgeV2/Semantic/", "Tests/Semantic/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(R-2): evalinvariantv1-engineering-entry",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"R-2","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
