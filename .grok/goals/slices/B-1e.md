# Goal slice — B-1e: EVM Map/Bytes/Option state pin
...
## Objective
Either lower EVM Map/Bytes/Option state or pin FAIL-CLOSED with tests and matrix.
...
```json
{
  "slice_id": "B-1e",
  "milestone": "D2",
  "objective": "Either lower EVM Map/Bytes/Option state or pin FAIL-CLOSED with tests and matrix.",
  "dependencies": [],
  "allowed_paths": ["ProofForgeV2/Targets/Evm/", "Tests/", "docs/research/12-target-coverage-matrix.md", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(B-1e): evm-map/bytes/option-state-pin",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"B-1e","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
