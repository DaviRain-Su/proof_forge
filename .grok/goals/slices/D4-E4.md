# Goal slice — D4-E4: solc OutputSet roles complete
...
## Objective
Align locked solc packaging roles with engineering OutputSet; no formal OutputSetV1 claim.
...
```json
{
  "slice_id": "D4-E4",
  "milestone": "D2",
  "objective": "Align locked solc packaging roles with engineering OutputSet; no formal OutputSetV1 claim.",
  "dependencies": ["D3-E4"],
  "allowed_paths": ["ProofForgeV2/Targets/Evm/", "ProofForgeV2/Materialization/", "Tests/", "docs/engineering-backlog.md"],
  ...
  "commit_message": "slice(D4-E4): solc-outputset-roles-complete",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D4-E4","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
