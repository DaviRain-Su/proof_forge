# Goal slice — D3-E3: BuildIdentity + plan digests complete
...
## Objective
Ensure all implemented targets bind planDigest into engineering BuildIdentity/OutputSet (T9d done; close residuals).
...
```json
{
  "slice_id": "D3-E3",
  "milestone": "D2",
  "objective": "Ensure all implemented targets bind planDigest into engineering BuildIdentity/OutputSet (T9d done; close residuals).",
  "dependencies": ["T9d"],
  "allowed_paths": ["ProofForgeV2/", "Tests/Materialization/", "docs/engineering-backlog.md"],
  ...
  "commit_message": "slice(D3-E3): buildidentity-+-plan-digests-complete",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D3-E3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
