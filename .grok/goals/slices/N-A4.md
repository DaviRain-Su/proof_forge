...
## Objective
Admit Option state in Normalize+Reference with structure-valid carrier; targets lower or explicit FAIL-CLOSED+tests.
...
```json
{
  "slice_id": "N-A4",
  "milestone": "D2",
  "objective": "Admit Option state in Normalize+Reference with structure-valid carrier; targets lower or explicit FAIL-CLOSED+tests.",
  "dependencies": ["N-A2"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-A4): option-state",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-A4","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
