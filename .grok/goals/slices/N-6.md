# Goal slice — N-6: True mutable locals
...
## Objective
Allow reassignment of let locals (not only field/index rebind) with SSA/CFG correctness; tests.
...
```json
{
  "slice_id": "N-6",
  "milestone": "D2",
  "objective": "Allow reassignment of let locals (not only field/index rebind) with SSA/CFG correctness; tests.",
  "dependencies": ["N-A2"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-6): true-mutable-locals",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-6","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
