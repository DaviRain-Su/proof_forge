# Goal slice — BUILD-5: Parallel deletion gates
...
## Objective
Run independent rg/python deletion gates in just dev-check with bounded parallelism and aggregated failures. Gates must remain fail-closed.
...
```json
{
  "slice_id": "BUILD-5",
  "milestone": "D2",
  "objective": "Run independent rg/python deletion gates in just dev-check with bounded parallelism and aggregated failures. Gates must remain fail-closed.",
  "dependencies": [],
  "allowed_paths": ["justfile", "scripts/gate_helpers.sh", "docs/engineering-backlog.md"],
  "focused_checks": ["just dev-check"],
  ...
  "commit_message": "slice(BUILD-5): parallel-deletion-gates",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"BUILD-5","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
