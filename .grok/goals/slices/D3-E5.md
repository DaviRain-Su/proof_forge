# Goal slice — D3-E5: CLI evidence/resource flags
...
## Objective
Implement remaining SPEC-CLI flags for evidence/resource overrides fail-closed.
...
```json
{
  "slice_id": "D3-E5",
  "milestone": "D2",
  "objective": "Implement remaining SPEC-CLI flags for evidence/resource overrides fail-closed.",
  "dependencies": [],
  "allowed_paths": ["ProofForgeV2/CLI/", "Tests/CLI/", "docs/specs/cli.md", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(D3-E5): cli-evidence/resource-flags",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D3-E5","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
