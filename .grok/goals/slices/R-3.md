# Goal slice — R-3: ProofBundleV1 safe loading
...
## Objective
Safe load path for ProofBundleV1 engineering; fail-closed on malformed. No formal evidence ceremony.
...
```json
{
  "slice_id": "R-3",
  "milestone": "D2",
  "objective": "Safe load path for ProofBundleV1 engineering; fail-closed on malformed. No formal evidence ceremony.",
  "dependencies": ["R-2"],
  "allowed_paths": ["ProofForgeV2/Semantic/", "Tests/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(R-3): proofbundlev1-safe-loading",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"R-3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
