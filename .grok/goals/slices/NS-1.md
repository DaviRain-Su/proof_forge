# Goal slice — NS-1: Fungible Token four-target demo
...
## Phase
`northstar` · milestone hint `D2` · shared_cutover `False`

## Objective
program Token example building four targets after Map/Principal/context prerequisites. Not IBC full stack.
...
Examples/
Tests/
docs/research/10-ibc-as-proofforge-programs.md
...
```json
{
  "slice_id": "NS-1",
  "milestone": "D2",
  "objective": "program Token example building four targets after Map/Principal/context prerequisites. Not IBC full stack.",
  "dependencies": ["N-1", "N-2", "B-3"],
  "allowed_paths": ["Examples/", "Tests/", "docs/research/10-ibc-as-proofforge-programs.md", "docs/engineering-backlog.md"],
  ...
  "commit_message": "slice(NS-1): fungible-token-four-target-demo",
  "constraints": "Serial shared-core if Normalize/Typed/Semantic. Never push. Never formal. Update engineering-backlog.md. Only after language prereqs."
}
```
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"NS-1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
