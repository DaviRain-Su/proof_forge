# Goal slice — R-1: Expand Reference admitted ops
...
## Phase
`reference` · milestone hint `D2` · shared_cutover `True`

## Objective
Grow ReferenceV1 admitted/step surface toward PureCall, aggregates, index, Int, Field, Principal, ContextRead, Commit as Normalize emits them. Tests per family.
...
```
ProofForgeV2/Semantic/ReferenceV1.lean
...
```json
{
  "slice_id": "R-1",
  "milestone": "D2",
  "objective": "Grow ReferenceV1 admitted/step surface toward PureCall, aggregates, index, Int, Field, Principal, ContextRead, Commit as Normalize emits them. Tests per family.",
  "dependencies": ["N-A2"],
  "allowed_paths": ["ProofForgeV2/Semantic/ReferenceV1.lean", "ProofForgeV2/Semantic/", "Tests/Semantic/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(R-1): expand-reference-admitted-ops",
  "constraints": "Serial shared-core if Normalize/Typed/Semantic. Never push. Never formal. Update engineering-backlog.md. Follow Normalize; do not invent ops Normalize cannot produce."
}
```
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"R-1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
...
## Notes
Follow Normalize; do not invent ops Normalize cannot produce.
