# Goal slice — D4-E3: EVM TargetIR schema/validator
...
## Objective
Add TargetIR schema/validator/hash/trace engineering gates for EVM IR.
...
```json
{
  "slice_id": "D4-E3",
  "milestone": "D2",
  "objective": "Add TargetIR schema/validator/hash/trace engineering gates for EVM IR.",
  "dependencies": ["D4-E1"],
  ...
  "commit_message": "slice(D4-E3): evm-targetir-schema/validator",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D4-E3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
