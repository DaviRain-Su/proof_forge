# Goal slice — C-4: Noir prove path research/implement
...
## Objective
If pinned nargo available, sketch prove/verify acceptance; else research doc + stay source-only.
...
```
ProofForgeV2/Targets/Noir/
docs/targets/07-noir.md
docs/research/
...
```json
{
  "slice_id": "C-4",
  "milestone": "D2",
  "objective": "If pinned nargo available, sketch prove/verify acceptance; else research doc + stay source-only.",
  "dependencies": [],
  "allowed_paths": ["ProofForgeV2/Targets/Noir/", "docs/targets/07-noir.md", "docs/research/", "docs/engineering-backlog.md"],
  ...
  "commit_message": "slice(C-4): noir-prove-path-research/implement",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"C-4","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
