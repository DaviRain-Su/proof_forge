# Goal slice — DOC-3: Refresh feature coverage audit L4/L6
...
## Objective
Update docs/research/11-feature-coverage-audit.md Reference admitted set and target maturity rows to match current code; link backlog.
...
```
docs/research/11-feature-coverage-audit.md
...
```json
{
  "slice_id": "DOC-3",
  "milestone": "D2",
  "objective": "Update docs/research/11-feature-coverage-audit.md Reference admitted set and target maturity rows to match current code; link backlog.",
  "dependencies": ["DOC-2"],
  "allowed_paths": ["docs/research/11-feature-coverage-audit.md", "docs/engineering-backlog.md"],
  ...
  "commit_message": "slice(DOC-3): refresh-feature-coverage-audit-l4/l6",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"DOC-3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
