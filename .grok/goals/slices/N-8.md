# Goal slice — N-8: Int events/errors and wide call/for ends
...
## Objective
Int fields on event/error; non-UInt64 call/schedule args and for endpoints where typed. Targets follow or FAIL-CLOSED.
...
```json
{
  "slice_id": "N-8",
  "milestone": "D2",
  "objective": "Int fields on event/error; non-UInt64 call/schedule args and for endpoints where typed. Targets follow or FAIL-CLOSED.",
  "dependencies": ["N-1"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-8): int-events/errors-and-wide-call/for-ends",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-8","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
