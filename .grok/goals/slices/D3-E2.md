# Goal slice — D3-E2: SupportClaim decision surface
...
## Objective
Align engineering SupportClaim fields/decision with SPEC intent without formal TASK claims.
...
```json
{
  "slice_id": "D3-E2",
  "milestone": "D2",
  "objective": "Align engineering SupportClaim fields/decision with SPEC intent without formal TASK claims.",
  "dependencies": ["D3-E1"],
  "allowed_paths": ["ProofForgeV2/Targets/", "Tests/Materialization/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(D3-E2): supportclaim-decision-surface",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D3-E2","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
