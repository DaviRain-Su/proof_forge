...
## Notes
- Resume entry: `prompt-c-2-finish.md` or master `starting at C-2`.
- Chat may leave Goal-owned draft at `docs/research/15-aleo-psy-compiler-vm.md`;
  only Goal may commit + mark backlog done.
- Research registration may touch `docs/research/README.md` (same research/ prefix).
