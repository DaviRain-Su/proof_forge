# Goal slice — T-3: RequirementsInfer context/commit keys
...
## Objective
Emit callerContext/commit contribution keys when N-2/N-3 land; freeze via RequirementsV1 only.
...
ProofForgeV2/Semantic/RequirementsV1.lean
Tests/
...
```json
{
  "slice_id": "T-3",
  "milestone": "D2",
  "objective": "Emit callerContext/commit contribution keys when N-2/N-3 land; freeze via RequirementsV1 only.",
  "dependencies": ["N-2", "N-3"],
  "allowed_paths": ["ProofForgeV2/Typed/RequirementsInferV1.lean", "ProofForgeV2/Semantic/RequirementsV1.lean", "Tests/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(T-3): requirementsinfer-context/commit-keys",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"T-3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
