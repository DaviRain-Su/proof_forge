# Goal slice — NS-2: Packet mailbox mini IBC-flavor
...
## Objective
Minimal packet mailbox program after NS-1.
...
```json
{
  "slice_id": "NS-2",
  "milestone": "D2",
  "objective": "Minimal packet mailbox program after NS-1.",
  "dependencies": ["NS-1"],
  ...
  "commit_message": "slice(NS-2): packet-mailbox-mini-ibc-flavor",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"NS-2","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
