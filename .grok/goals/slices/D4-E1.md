# Goal slice — D4-E1: EVM Plan schema + hash binding
...
## Objective
Engineering EvmPlan canonical schema/hash bound to BuildIdentity without formal TASK-D4-01 done claim.
...
```json
{
  "slice_id": "D4-E1",
  "milestone": "D2",
  "objective": "Engineering EvmPlan canonical schema/hash bound to BuildIdentity without formal TASK-D4-01 done claim.",
  "dependencies": ["D3-E3"],
  "allowed_paths": ["ProofForgeV2/Targets/Evm/", "Tests/Materialization/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "commit_message": "slice(D4-E1): evm-plan-schema-+-hash-binding",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"D4-E1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
