# Goal slice — N-1: Map construct + state/param + index
...
## Objective
Lower non-empty Map construct and Map state/param/indexGet/Set through Normalize to structure-valid SemanticProgramV1; Reference as needed; targets lower or FAIL-CLOSED+tests.
...
```json
{
  "slice_id": "N-1",
  "milestone": "D2",
  "objective": "Lower non-empty Map construct and Map state/param/indexGet/Set through Normalize to structure-valid SemanticProgramV1; Reference as needed; targets lower or FAIL-CLOSED+tests.",
  "dependencies": ["N-A4"],
  "allowed_paths": ["ProofForgeV2/Semantic/", "ProofForgeV2/Typed/", "ProofForgeV2/Targets/", "Tests/", "docs/engineering-backlog.md", "docs/research/12-target-coverage-matrix.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-1): map-construct-+-state/param-+-index",
  "constraints": "Serial shared-core if Normalize/Typed/Semantic. Never push. Never formal. Update engineering-backlog.md. Large slice; keep minimal first cut."
}
```
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
...
## Notes
Large slice; keep minimal first cut.
