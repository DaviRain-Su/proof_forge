# Goal slice — T-2: Context/extension in CheckV1
...
## Objective
Thread context/extension requirements into CheckV1 composition.
...
```json
{
  "slice_id": "T-2",
  "milestone": "D2",
  "objective": "Thread context/extension requirements into CheckV1 composition.",
  "dependencies": ["N-2", "T-1"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(T-2): context/extension-in-checkv1",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"T-2","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
