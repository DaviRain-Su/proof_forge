# Goal slice — N-A3: Map/Bytes element assign
...
## Objective
Support nested assign through Map/Bytes elements (or document permanent FAIL-CLOSED with tests). Align with N-1/N-BYTES.
...
```json
{
  "slice_id": "N-A3",
  "milestone": "D2",
  "objective": "Support nested assign through Map/Bytes elements (or document permanent FAIL-CLOSED with tests). Align with N-1/N-BYTES.",
  "dependencies": ["N-1"],
  "allowed_paths": ["ProofForgeV2/Semantic/", "ProofForgeV2/Targets/", "Tests/", "docs/engineering-backlog.md", "docs/research/12-target-coverage-matrix.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(N-A3): map/bytes-element-assign",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"N-A3","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
