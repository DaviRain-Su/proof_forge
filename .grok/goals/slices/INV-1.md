# Goal slice — INV-1: Constrained proof reference product path
...
## Objective
Product path for constrained proof references (FR-002 Phase-1 language) without Lean term escape.
...
```json
{
  "slice_id": "INV-1",
  "milestone": "D2",
  "objective": "Product path for constrained proof references (FR-002 Phase-1 language) without Lean term escape.",
  "dependencies": ["R-2"],
  "allowed_paths": ["ProofForgeV2/", "Tests/", "docs/engineering-backlog.md", "supply-chain/"],
  ...
  "shared_cutover": true,
  "commit_message": "slice(INV-1): constrained-proof-reference-product-path",
...
2. Optional: workflow `proof-forge-one-slice` with args
   `{"slice":"INV-1","base_commit":"<BASE>","task_prompt":"<one-line objective>","changed_files":[...]}`
