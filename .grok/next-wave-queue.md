...
| TON-MAP-INT | main | TON dense Map UInt64 Int64 (cap-8) state. Reuse Map UInt64 UInt64 24-leaf occ/key/val flatten. occ/key unsigned uint64 cells; only each val leaf isInt=true / int64 / loadInt. Not Map-of-Int8, not Int64-key, not Map UInt128, not CW/Aleo | hash left for Commit |
