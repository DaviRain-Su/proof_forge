...
| TON-OPT-U128 | main | TON anonymous Option UInt128 as unsigned tag uint64 cell + one uint128 payload cell (`loadUint(128)`; not CosmWasm 2-limb / not two UInt64 leaves). Reuse Option tag/storeAtomic/match. Option UInt128 return / Option UInt256 / Map UInt128 stay FC | hash left for Commit |
