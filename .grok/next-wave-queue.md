...
| CW-MAP-INT | main | CosmWasm dense Map UInt64 Int64 (cap-8) state. Reuse Map UInt64 UInt64 24-leaf occ/key/val flatten + loop IR. occ/key unsigned UInt64; only each val leaf isInt=true / i64-le. Not Map-of-Int8, not Int64-key, not Map UInt128, not TON/Aleo | hash left for Commit |
