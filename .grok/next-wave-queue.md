...
| TON-OPT-INT | main | TON anonymous Option Int64 state as existing 2-leaf Option layout (`name_tag` unsigned uint64 cell + `name_p0` signed int64 cell / loadInt). Reuse Option UInt64 tag/payload/storeAtomic/match. Not Option-of-Int8/16/32, not Option-of-UInt128, not Option Int64 return, not CW/Aleo | hash left for Commit |
