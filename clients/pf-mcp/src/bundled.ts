...
export const DOCS_INDEX_JSON = {
  ...
  "docs": [
    ...
    },
    {
      ...
      "title": "Aleo dApp 前端：Wallet Adapter · Provable SDK · 与 ProofForge 的分工",
      "bytes": 16801,
      "kind": "markdown"
    },
    {
      "id": "08-evm-dapp-frontend.md",
      "title": "EVM dApp 前端：viem · MetaMask · 与 ProofForge 的分工",
      "bytes": 4222,
      "kind": "markdown"
    },
    {
    ...
    },
    {
      ...
      "title": "Demo: EVM with `pf` — build → local Anvil → browser",
      "bytes": 1718,
      "kind": "markdown"
    },
    {
