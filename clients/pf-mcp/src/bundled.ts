...
export const CATALOG_JSON = {
  ...
  "notes": [
    ...
    "EVM frontend detail: docs/product/08-evm-dapp-frontend.md + templates/evm-dapp-ui (viem/local Anvil).",
    "Solana: dual MCP — ProofForge guidance + official https://mcp.solana.com/mcp (docs/autofixer)."
  ],
  "targets": [
    {
      "id": "aleo",
    ...
    },
    {
      ...
      "frontendClients": [
        {
          ...
          "kind": "js-ts",
          "purpose": "typed RPC, deploy/call StateCell-shaped ABI; default template stack",
          "shippedByProofForge": false,
          "docs": [
            "https://viem.sh",
      ...
      "honesty": [
        ...
        "pf v0 refuses EVM public-chain broadcast; local Anvil only for write demos",
        "see PRODUCT-EVM-DAPP-FRONTEND and templates/evm-dapp-ui"
      ],
    ...
    },
    {
      ...
      "pfSurface": {
        ...
        "officialMcp": {
          ...
          "note": "Connect alongside ProofForge MCP; PF does not proxy these tools."
        }
      },
      "frontendClients": [
        {
          "name": "@solana/web3.js / @solana/kit (ecosystem)",
          "kind": "js-ts",
          "purpose": "RPC, transaction build/send",
          "shippedByProofForge": false,
          "docs": [
        ...
        {
          "name": "@solana/wallet-adapter (ecosystem)",
          "kind": "js-ts",
          "purpose": "React wallet connect UX",
          "shippedByProofForge": false,
          "packages": [
      ...
      "localDev": {
        ...
        "chainLike": "Mollusk runtime tests (host-heavy; just solana-runtime / pf test)",
        "deploy": "pf deploy --network local (save-only); --broadcast loopback only"
      },
      "honesty": [
        "Principal is not Solana pubkey globally",
        "Public RPC broadcast refused in pf v0",
        "Use official Solana MCP for Anchor/Pinocchio Rust autofixer — separate from PF Lean→sBPF path",
