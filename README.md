...
从 GitHub Release 取 **engineering-dist bundle**（`proof-forge-bundle-<ver>-<plat>.tar.gz`，含 `pf` + `proof-forge-next` + olean + scripts）。详见 [ADR-0040](docs/adr/0040-external-author-host-mode-and-bundle.md) · [cheatsheet](docs/product/16-external-author-cheatsheet.md) · [MVP](docs/product/14-external-author-mvp.md)。
