...
| [ADR-0034](0034-preservation-abi.md) | Preservation ABI（proposed extension/amendment to ADR-0027；L1 step-preservation；通用 ABI + kind plumbing + **EvenCounter preserving product positive GREEN**；业务主路径 D10 vs 工具 formal track 2；第二实例/supersession pending；禁止 MiniAmm 特例；ADR-0027 仍为 inline base authority） | proposed |
