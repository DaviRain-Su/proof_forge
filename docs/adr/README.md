...
| [ADR-0053](0053-call-bind-v1.md) | Call-bind v1：编译期 opt-in `proof-forge.call-bind.v1`；Wave 2 三叶 generic call 无行 fail closed；Wave 2a 空账户 void CALL FC（Solana accounts 另刀） | proposed |
