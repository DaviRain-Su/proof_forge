...
| [ADR-0048](0048-optional-solana-sbpf-semantics-provider.md) | 可选 exact-pinned `SbpfSemantics.Api` 边界；shared production lowering source → resolved sBPF semantics，产品 ELF rail 不变 | proposed |
