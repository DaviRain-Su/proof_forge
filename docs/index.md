...
**ProofShip**（黑客松产品主品牌 · AI-RWA 首发 vertical）：定位 [`product/proofship-positioning.md`](product/proofship-positioning.md) · 竖切 plan [`plan/ai-rwa-verified-ship-xlayer.md`](plan/ai-rwa-verified-ship-xlayer.md)（非 formal / 非 accepted PRD 扩面）。**应用代码已迁出**本 monorepo（独立仓库）；此处仅保留品牌/计划文档。
