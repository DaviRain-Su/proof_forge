...
Noir ACIR 物化规划：[`targets/07-noir-acir-lowering.md`](targets/07-noir-acir-lowering.md)（**Active**；IR-0..IR-3 done → IR-5/IR-6；金样 `testdata/golden/noir-acir-v1/` + G3 circuit-hash pins）。
