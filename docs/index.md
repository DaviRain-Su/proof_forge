...
Aleo Instructions IR 物化规划：[`targets/09-aleo-instructions-lowering.md`](targets/09-aleo-instructions-lowering.md)（**Active**；IR-0..IR-6 / G0–G4 closeout done；Next = G5 residual）。
