...
**ProofShip**（黑客松产品主品牌 · AI-RWA 首发 vertical）：[`product/proofship-positioning.md`](product/proofship-positioning.md) · 竖切 plan [`plan/ai-rwa-verified-ship-xlayer.md`](plan/ai-rwa-verified-ship-xlayer.md)（非 formal / 非 accepted PRD 扩面）。
...
**External Author MVP**（bundle · host dev · setup · CI；默认不 lake）：[`product/14-external-author-mvp.md`](product/14-external-author-mvp.md) · 单页 cheatsheet [`product/16-external-author-cheatsheet.md`](product/16-external-author-cheatsheet.md) · [ADR-0040](adr/0040-external-author-host-mode-and-bundle.md)。
