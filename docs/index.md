...
Solana 双 MCP：PF 脚手架 `pf_solana_scaffold` + 官方 [`Solana Developer MCP`](https://mcp.solana.com/)（`https://mcp.solana.com/mcp`）· 见 [`product/09-solana-agent-playbook.md`](product/09-solana-agent-playbook.md)。
