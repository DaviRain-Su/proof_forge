...
工程 registry **13 = 13 implemented + 0 design-only**（含 Soroban ADR-0044、OpenVM ADR-0045/0046、ICP ADR-0047、XRPL ADR-0049/0050；host 三键 ADR-0052 proposed、叶未开；ADR-0053 call-bind Wave 1 proposed、只解析不改 emit）。Quint 是
