...
| 技术规格 | [`03-technical-spec.md`](03-technical-spec.md) + `specs/` | `accepted` | API、schema、错误和版本；包含已批准的`SPEC-TASKQUAL-001` C3 terminal-signing amendment |
| 实施计划 | [`04-task-breakdown.md`](04-task-breakdown.md) | `accepted` | 任务顺序与任务验收 |
| 测试 | [`05-test-spec.md`](05-test-spec.md) | `accepted` | 验收和证据要求；包含已批准的ADR-0021 v2 negative matrix |
...
`T-019f7dea-e600-77ea-8884-9f35f81f747d`。2026-07-23 C3 terminal-signing amendment以
`ADR-0021`、当前`SPEC-TASKQUAL-001`与PHASE-5为同一accepted unit；reviewCommit固定为
`3d68d8658cc26ce95201b277b10e4a94103836af`，reviewLink为对应GitHub commit，独立复审P0/P1=0。
