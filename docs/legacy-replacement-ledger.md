...
- **Resolved prerequisite:** IR-B7b. Canonical Core emits physical EVM
  scalar/map/array storage targets and the strict Yul renderer accepts only
  `ModulePlan`. Counter may now leave the compatibility source path.
