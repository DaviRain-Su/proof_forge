...
- EVM `origin`, `prevrandao`, `gas_price`, `base_fee`, `coinbase`, and
...
2. [x] Move Solidity error ABI data to `EvmPlan`. Canonical error values now
...
3. [x] Move fallback/receive dispatch to target interface metadata. Legacy and
