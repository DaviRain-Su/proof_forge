...
| 明确拒 | event / sync call / async / pf.assets / nonempty invariants / Int8/16/32 state·params / mixed UInt64↔Int64 / Map/Bytes / Array·Option return·params / Array-of-non-UInt64 / Option-of-non-UInt64 / N∉1..8 / signedNumeric+Array / signedNumeric+Option / `symbol_short!` key >9 bytes（never truncate） |
