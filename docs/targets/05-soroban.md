...
| 明确拒 | event / sync call / async / pf.assets / nonempty invariants / Int8/16/32 state·params / mixed UInt64↔Int64 / Array·Option·Map **params** / 错域 Array/Option/Map 元素 / nonempty Map construct / N∉1..8 / `symbol_short!` key >9 bytes（never truncate） |
