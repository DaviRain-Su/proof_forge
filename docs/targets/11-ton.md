...
**后续工程扩面**：UInt8/16/32/128/256 与 Int8/16/32/64 state/param/result 已开（Tolk
`intN`/`uintN` cell + `loadInt`/`loadUint` + int257 width guards；**UInt128 = 单个
`uint128` cell + `body.loadUint(128)` + `assert (0 <= t && t < (1 << 128))`**；
