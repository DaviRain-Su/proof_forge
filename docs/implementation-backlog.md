...
| Order | Slice | State | Acceptance boundary |
|---:|---|---|---|
| LR-0 | Artifact Contract v1 docs + harness field allowlist | done (verified on branch `DaviRain-Su/artifact-contract-v1`) | testkit/runners depend only on documented artifact fields; honesty rules unchanged; `just artifact-contract-v1` green |
