...
| A-CUT3 | Migrate Product/stdlib callers and delete their `Source.Legacy` dependencies | in_progress (ValueVault direct and native-differential verified) | migrate the authorization representative next, then map/collection, event/error, and portable crosscall families |
...
| CMP-3 | ValueVault and representative stateful portable families | in_progress | ValueVault primary-triad VM comparison is verified; select the authorization representative next |
