...
| 顺序 | 切片 | 状态 | 验收边界 |
|---:|---|---|---|
| LR-0 | Artifact Contract v1 文档 + harness 字段白名单 | done（分支 `DaviRain-Su/artifact-contract-v1` 验证） | testkit/runners 只依赖文档化制品字段；诚实性规则不变；`just artifact-contract-v1` 通过 |
