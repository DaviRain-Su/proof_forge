...
| CMP-3 | ValueVault 和代表性 stateful portable family | in_progress | ValueVault、Ownable、Pausable、ReentrancyGuard 与 ArrayExample 主三链 VM comparison 已验证至 `0035138e`；下一证据 family 跟随 direct map 切换 |
