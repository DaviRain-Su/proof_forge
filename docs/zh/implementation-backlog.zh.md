...
| A-CUT3 | 迁移 Product/stdlib 调用方并删除其 `Source.Legacy` 依赖 | in_progress（StatusMessage direct 完成于 `2ea8b134`） | 完成 CMP-3h map/event 原生证据，再把同一 direct boundary 扩展到 GuestBook 与后续 crosscall family |
