...
`Counter`、`ArrayExample`、`ValueVault`、`RoleGatedToken` 和 `StakingVault`
是主要的多目标 shared contract 场景。
...
constructor probe、proxy probe 和 `stdlib/` wrapper 是 EVM-focused fixture，
