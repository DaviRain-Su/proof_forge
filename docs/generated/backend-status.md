...
| `wasm-arbitrum-stylus` | `research` | `contract-source` | `build`, `check` | `sourcegen`, `intermediate` | `plan` | Counter research slice via canonical StylusPlan and pinned Rust SDK renderer; direct HostIO Wasm and deploy support unavailable |
