...
| `wasm-arbitrum-stylus` | `research` | `contract-source` | `build`, `check` | `sourcegen`, `intermediate` | `plan` | Counter research slice via canonical StylusPlan and pinned Rust SDK renderer; direct Counter WAT and abstract differential gate; native HostIO runtime and deploy support unavailable |
