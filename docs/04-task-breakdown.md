...
| D1-PA-85 | TASK-D1-05 | exact bind reconstructed `Source.Program.name` 与 export declaration 最后一个 `Name.str` component 的 isolated `Name.toString` rendering；保留 PA82→PA83→PA84 priority | — | frozen completion package；下一步 tests-only RED；simple/escaped-hyphen/escaped-dot positive、single/table short-name mismatch、PA84/PA83/`PF-EXPORT-004` priority controls；RED ≤180、GREEN ProgramPayload ≤480；完成后该代码路径 pre-acceptance 饱和；不含 wire component identity、NodeId/origin、D1-06 或正式 `TST-SRC-006/007` closure | frozen (development) |
...
| TASK-D1-05 | `Source.Program` stable attribute export/schema | TASK-D1-03 | — | TST-SRC-006, TST-SRC-007 | EV-20260719-0079, EV-20260719-0080, EV-20260719-0081, EV-20260719-0082 | pending |
