...
| D1-PA-93 | TASK-D1-01 | production `SourceNameComponentV1` raw Lean `Name.str` carrier + typed wire encode/decode；PA91 `encodeIdent` validation migrates to raw carrier；independent Python raw oracle | `1f1a819f`；implementation pending | 新增 `NameComponentV1`≤65、suite≤125；WireCodec/WireDecode/PA91 suite+Python 与 registration authored deltas≤65；总 authored ≤255（机械 manifest 不计）；禁止 ProgramV1/SourceQualifiedName root/model/hash/NodeId 与 Common/Syntax/Loader/Core.Source/ProgramPayload/target 改写；focused+aggregate+Python+final single SBOM+docs/diff+independent review；不运行完整 `just ci`，不关闭 formal task | frozen (development) |

| ID | 任务/输出 | Dependencies | Prerequisites | Tests | Evidence | 状态 |
|---|---|---|---|---|---|---|
| TASK-D1-01 | source token、span、NodeId | TASK-D0-01, TASK-D0-02, TASK-D0-03, TASK-D0-04, TASK-D0-07 | — | TST-SRC-001, TST-SRC-002 | EV-20260717-0036, EV-20260719-0087, EV-20260719-0088, EV-20260719-0089, EV-20260719-0090 | pending |
