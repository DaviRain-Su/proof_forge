...
| D1-PA-86 | TASK-D1-05 | tests-only labeled acceptance entrypoint for frozen `TST-SRC-006/007`：exact schema/diagnostic/empty registry goldens、AB/BA diamond order、cross-row duplicate/conflict 与 decode→identity→binding priority；零 production change | — | frozen executable-verification package；新增 `ProgramExportAcceptance` + isolated empty-registry snapshot，总新增 ≤150 行并最小注册；focused/aggregate/test binary、docs-check、diff 与 independent review 后只记录 development evidence；不运行完整 `just ci`/SBOM，不关闭 formal task，不进入 D1-06 | frozen (development) |
...
| TASK-D1-05 | `Source.Program` stable attribute export/schema | TASK-D1-03 | — | TST-SRC-006, TST-SRC-007 | EV-20260719-0079, EV-20260719-0080, EV-20260719-0081, EV-20260719-0082, EV-20260719-0083 | pending |
