...
| D1-PA-84 | TASK-D1-05 | exact bind `ProgramExportV1.declaration.toString` 与 reconstructed `Source.Program.qualifiedName`；single API decode 后绑定，table 保留 PA83 collision-before-binding priority | — | frozen completion package；下一步 tests-only RED；exact `PF-EXPORT-001: exported program identity does not match declaration`、nested/escaped positive、single/table mismatch、`PF-EXPORT-004` 与 PA83 diagnostic priority controls；不含 short-name/wire component binding、`PF-EXPORT-002/003`、CLI/Loader、target、worker 或正式 `TST-SRC-006/007` closure | frozen (development) |
...
| TASK-D1-05 | `Source.Program` stable attribute export/schema | TASK-D1-03 | — | TST-SRC-006, TST-SRC-007 | EV-20260719-0079, EV-20260719-0080, EV-20260719-0081 | pending |
