...
| D1-PA-20 | TASK-D1-04 | bounded `let name [ : Type ] := Expr` Source statement carrier；Typed fail-closed boundary | — | authority/grammar/canonical audits；spec freeze before RED | **active** |
