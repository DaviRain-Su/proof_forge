...
| **PF-CLI** | Rust Developer CLI `pf`（ADR-0037） | Aleo 闭环 + multi-target build/clean/smoke + **D7a Solana verify** | **D0–D6 + D7a done**（2026-08-10：`pf verify -t solana` wrap solana-client）；**Next=D7c EVM Anvil test / D7b Mollusk**——见 [`plan/pf-cli-aleo.md`](plan/pf-cli-aleo.md) |
