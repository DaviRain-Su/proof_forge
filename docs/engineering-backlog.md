...
| **NOIR-IR** | ProgramV1 → ACIR 权威物化（去 sole .nr） | **in progress（2026-08-08）**：规划见 [`targets/07-noir-acir-lowering.md`](targets/07-noir-acir-lowering.md)。IR-0/IR-1 done → IR-2 MVP；nargo 1.0.0-beta.26；**非** prove/formal |
