...
| 2026-08-06 | **ADR-0032 U1 Solana 统一 materializer 启动**：sole rail = `solana-sbpf-cpi-elf-v1` 吸收 full body；single-account plan/elf 为过渡 shim；P2–P3-f + **P3-g content-bound hybrid irDigest**（消灭 evidence 字面 `full-body-hybrid`；`sha256:` 可从 cpi-ir 重算）已绿；P3-e multi-role AccountMeta recipes / P4 默认 profile 切换仍后续 |
