...
| 2026-08-06 | **ADR-0032 U1 Solana 统一 materializer 启动**：sole rail = `solana-sbpf-cpi-elf-v1`；P2–P3-g + **P3-e foundation**（`ProductCpiRecipesV1`；full-body `system.transfer` 正确 System pid+12B data；`BodyCpiSysPay` pin；multi-role AccountMeta walker 仍 pending）已绿；P4 默认 profile 切换仍后续 |
