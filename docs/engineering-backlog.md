...
| **PF-CLI** | Rust Developer CLI `pf`（ADR-0037） | Aleo-first build/check/inspect/local run 与 save-only deploy/execute；compiler 权威保持在 `proof-forge-next` | **done**（2026-08-10：`clients/pf-cli` clap 命令面、安全门、JSON envelope、README 与 just recipes） |
