...
| **ALEO-IR** | ProgramV1 → Aleo Instructions 权威物化（去 sole Leo 源） | **in progress（2026-08-08）**：规划见 [`targets/09-aleo-instructions-lowering.md`](targets/09-aleo-instructions-lowering.md)。官方 Leo→Instructions→AVM；权威 = Instructions IR（对标 Psy DPN）。**IR-0/IR-1/IR-2 done**；Next = `IR-3` 控制流 → 多叶/诚实矩阵 → 产品 primary IR（IR-6）；Leo 源仍产品过渡。**非** prove/deploy/formal |
