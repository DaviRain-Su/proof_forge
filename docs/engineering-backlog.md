...
| **COMP-2-SOL-CPI** | generic call-bind 支持子集已完成；剩 Token/ATA binding 诚实化、WideDiv 差分；扩大 schedule/result/multi-callee 前另决策 | **partial** — Wave 3 product/runtime closure done；其余 pending |
