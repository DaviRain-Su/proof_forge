...
| 2026-08-06 | **ADR-0032 U1 Solana 统一 materializer 启动**：sole rail = `solana-sbpf-cpi-elf-v1`；P2–P3-g + **P3-e multi-role system.transfer**（outer walk + AccountMeta + 12B；`BodyCpiSysPay` pin `p3e-system-transfer-multi-role`/`unifiedCpi`；非 system sites 仍 empty-meta）已绿；P4 默认 profile 切换仍后续 |
