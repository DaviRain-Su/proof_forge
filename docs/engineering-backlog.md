...
| **ALEO-G5-MATRIX** | §3.2 admit 扫描 + FC pins | **done（2026-08-08）**：§3.2 Instructions 现状列 + §3.2.1；Bool/assert/const/nested Map pins；原 residual 桶见 G5-HARD |
...
| **ALEO-CONST** | Constant → Instructions 或 plan-FC 钉死 | **pending** |
