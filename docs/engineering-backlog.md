...
| **C-5** | Solana 已有 Mollusk；扩 fixture 跟 Normalize 新面 | **ongoing**（Counter + 18 fixtures = 19 programs；#111 移除 CpiCaller/legacy call 运行时；OptionState 与聚合返回保留；MapMini/WideMul/PrincipalStore 保持真实 ELF+Mollusk；manifest-bound artifact 读取已接线） |
