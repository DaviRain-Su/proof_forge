...
| **PF-CLI** | Rust Developer CLI `pf`（ADR-0037） | D0–D9 + D10 twin registry skeleton | **done 工程主轴**（2026-08-10）；D11 Solana/EVM network deploy **deferred**——见 [`plan/pf-cli-aleo.md`](plan/pf-cli-aleo.md) |
