...
| 2026-08-18 | **Aleo Map param + 6-leaf return**：复用既有 cap-2 `flattenTypeLeafSpecsV1`（occ/key/val × 2 = 6 ≤ B-RET 8）。`Map UInt64 UInt64` / `Map UInt64 Int64` entry/view return 与 named param flatten 已开。**不**发明 24 叶 B-RET-MAP。Int64-key / nested / Map-of-Option / EVM·Solana·Noir·Psy Map return 仍 FC |
