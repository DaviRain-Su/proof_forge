...
27. [`23-miniamm-formalization-ladder.md`](23-miniamm-formalization-ladder.md)：**通用程序形式化栈** L0/L1/L2 + **首个实例 MiniAmm**；product Reference step 唯一、每合约只提供 P/投影；第二实例验收通用性；D/L2 formal 最后（RPT-023；2026-08-07）。
