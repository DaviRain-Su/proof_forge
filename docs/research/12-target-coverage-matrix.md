...
| anonymous Array/Option/Map view result | **LOWERED** | `Array UInt64/Int64 N`(1..8) / `Option UInt64/Int64` / Bytes N / **B-RET-MAP** `Map UInt64 UInt64` 或 `Map UInt64 Int64` 24 叶 view；entry 聚合、nested/Int8/Int64-key 仍 FC |
...
| irreducible CFG、Field/String | **FAIL-CLOSED** | Principal return 仍 FC |
