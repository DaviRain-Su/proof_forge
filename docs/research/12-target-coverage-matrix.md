...
| multi-block for / irreducible CFG、Field/String | **FAIL-CLOSED** | `loopBounds` / bounded-for 仍 FC；Principal / Bytes **entry** / Map return 仍 FC |
