object "ValueVault" {
  code {
    ...
    function f_ValueVault_initialize(initial) {
      ...
      sstore(2, or(and(sload(2), not(shl(192, 18446744073709551615))), shl(192, 1)))
      {
    ...
    function f_ValueVault_deposit(amount) {
      ...
      let ops := and(shr(192, sload(2)), 18446744073709551615)
      ...
      sstore(2, or(and(sload(2), not(shl(192, 18446744073709551615))), shl(192, next_ops)))
      {
