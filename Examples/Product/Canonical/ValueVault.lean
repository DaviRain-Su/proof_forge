...
/-! Surface v2 ValueVault matching the product contract's public behavior. -/

open ProofForge.Frontend.Surface

namespace Examples.Product.Canonical.ValueVault
...
end Examples.Product.Canonical.ValueVault
