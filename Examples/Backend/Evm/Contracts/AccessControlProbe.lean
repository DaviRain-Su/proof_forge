...
contract_source AccessControlProbe do
  ...
  entry init do
    ...
    do writeRoleMember roleMembers defaultAdminRole (ProofForge.Contract.Source.Legacy.ref admin) (u64 1);
  ...
  entry grantMinter (who : .address) do
    ...
    do writeRoleMember roleMembers minterRole (ProofForge.Contract.Source.Legacy.ref who) (u64 1);
