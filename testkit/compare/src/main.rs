...
fn run_near_compare_generic(
    ...
    let manifest_path = repo_root.join(reference_manifest_rel);
    let reference_source = fixture_dir.join("src/lib.rs");
    ...
    let report = json!({
        ...
        "implementations": {
            ...
            "near-sdk-rs": {
                "source": fixture_rel,
                "manifest": reference_manifest_rel,
                "built": sdk_built,
                "note": sdk_note,
                "wasmPath": if sdk_built {
...
fn run_near_fungible_token(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/fungible-token/reference-manifest.json",
...
fn run_near_ownable(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/differential/ownable/references/near.v1.json",
...
fn run_near_staking_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/staking-vault/reference-manifest.json",
...
fn run_near_role_gated_token(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/role-gated-token/reference-manifest.json",
...
fn run_near_fee_token(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/fee-token/reference-manifest.json",
...
fn run_near_guestbook(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/guestbook/reference-manifest.json",
...
fn run_near_storage_deposit(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/storage-deposit/reference-manifest.json",
...
fn run_near_ownable_pausable(repo_root: &Path, args: &Args) -> Result<()> {
    run_near_compare_generic(
        ...
        "testkit/compare/near/ownable-pausable/reference-manifest.json",
...
fn run_near_ownable_hash(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/ownable-hash/reference-manifest.json",
...
fn run_near_host_env_probe(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/host-env-probe/reference-manifest.json",
...
fn run_near_pro_rata_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/pro-rata-vault/reference-manifest.json",
...
fn run_near_soulbound_token(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/soulbound-token/reference-manifest.json",
...
fn run_near_height_lock_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/height-lock-vault/reference-manifest.json",
...
fn run_near_timelock_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/timelock-vault/reference-manifest.json",
...
fn run_near_escrow_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/escrow-vault/reference-manifest.json",
...
fn run_near_vesting_vault(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/vesting-vault/reference-manifest.json",
...
fn run_near_access_control(repo_root: &Path, args: &Args) -> Result<()> {
    ...
    run_near_compare_generic(
        ...
        "testkit/compare/near/access-control/reference-manifest.json",
