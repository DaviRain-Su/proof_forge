...
lean_lib ProofForgeV2Tests where
  roots := #[
    ...
    `Tests.Semantic.PreservationShapeV1,
    `Tests.Semantic.UInt64ParitySubjectV1,
    `Tests.Semantic.InvariantTheoremV1,
    `Tests.Semantic.ProofBridgeV1,
    `Tests.Semantic.SubjectDataBridgeV1,
    ...
    `Tests.Semantic.SimpleClosureDecodeV1,
    `Tests.Semantic.SimpleClosureDecodeRootQnV1,
    `Tests.Semantic.SimpleClosureDecodeFixedFieldsV1,
    `Tests.Semantic.SimpleClosureDecodeCallableV1,
    `Tests.Semantic.SimpleClosureDecodeComposeV1,
    `Tests.Semantic.ProofedClosedCertV1,
    `Tests.Semantic.ReferenceV1,
    `Tests.Semantic.OutcomeWireV1,
    `Tests.Semantic.StepFacadeV1,
    `Tests.Semantic.Sem001ShapeV1,
    ...
    `Tests.Semantic.NormalizeMerkleVerifyV1,
    ...
    `Tests.Materialization.SolanaCpiTokenV1,
    `Tests.Materialization.SolanaCpiAtaV1,
    ...
    `Tests.Product.BodyCpiSysPaySolanaV1,
